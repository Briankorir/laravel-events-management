      ...
      <nav class="fh5co-nav-style-1" role="navigation" data-offcanvass-position="fh5co-offcanvass-left">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-4 pull-right text-right fh5co-link-wrap">
              <ul class="fh5co-special" data-offcanvass="yes">
                ...
                <li><a href="/login" class="call-to-action">ADMIN Login</a></li>
              </ul>
            </div>
  		...
  		<div class="fh5co-cover fh5co-cover-style-2 js-full-height imond" data-stellar-background-ratio="0.5" data-next="yes">
              ...
              <div class="col-md-6 col-md-offset-3 full-height js-full-height text-center">
  							<div class="fh5co-cover-intro">
  								<h1 class="cover-text-lead wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">Amazing Events</h1>
  								<h2 class="cover-text-sublead wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s">Give us the opportunity to serve you, we are the awesome service providers</h2>
			...
			<div class="container">
				<div class="row p-b">
					<div class="col-md-6 col-md-offset-3 text-center">
						...
						<p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s">We have Done a number of executive events around the north rift region</p>
						<p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.1s"><a href="#" class="btn btn-success btn-lg">Check The gallery</a></p>
					</div>
				</div>
			</div>
							...
							<div class="container">
								<div class="fh5co-text">
									<div class="fh5co-text-inner">
										<div class="row">
											<div class="col-md-6"><h3>The Dome Events</h3></div>
											<div class="col-md-6"><p>Proffesional setup of the dome, ask for the service.</p></div>
										</div>
									</div>
								</div>
							</div>
						...
						<a href="#">
							...
							<div class="container">
								<div class="fh5co-text">
									<div class="fh5co-text-inner">
										<div class="row">
											<div class="col-md-6"><h3>Hexagone Tents</h3></div>
											<div class="col-md-6"><p>Need an executive event setup with a feel of royalty? give us a call</p></div>
										</div>
									</div>
								</div>
							</div>
						...
						<a href="#">
							...
							<div class="container">
								<div class="fh5co-text">
									<div class="fh5co-text-inner">
										<div class="row">
											<div class="col-md-6"><h3>Regular Tent Setup</h3></div>
											<div class="col-md-6"><p>We scrap off the traditional feel and design elegance for your events</p></div>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="fh5co-blog-style-1">
			<div class="container">
				<div class="row p-b">
					<div class="col-md-6 col-md-offset-3 text-center">
						<h2 class="fh5co-heading wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">Recent Events</h2>
						<p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s"> Check our recent Events</p>
					</div>
				</div>
				<div class="row p-b">
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
						<div class="fh5co-post wow fadeInLeft"  data-wow-duration="1s" data-wow-delay="1.1s">
							<div class="fh5co-post-image">
								<div class="fh5co-overlay"></div>
								<div class="fh5co-category"><a href="#">Sirikwa</a></div>
								<img src="images/ful.jpg" alt="Image" class="img-responsive">
							</div>
							<div class="fh5co-post-text">
								<h3><a href="#">Dinner Setup </a></h3>
								<p>Dinner Setup for an executive client a Sirikwa Hotel</p>
							</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
						<div class="fh5co-post wow fadeInLeft"  data-wow-duration="1s" data-wow-delay="1.4s">
							<div class="fh5co-post-image">
								<div class="fh5co-overlay"></div>
								<div class="fh5co-category"><a href="#">Highlands Inn</a></div>
								<img src="images/ful.jpg" alt="Image" class="img-responsive">
							</div>
							<div class="fh5co-post-text">
                <h3><a href="#">Dinner Setup </a></h3>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12">
						<div class="fh5co-post wow fadeInLeft"  data-wow-duration="1s" data-wow-delay="1.7s">
							<div class="fh5co-post-image">
								<div class="fh5co-overlay"></div>
								<div class="fh5co-category"><a href="#">Kenmosa</a></div>
								<img src="images/ful.jpg" alt="Image" class="img-responsive">
							</div>
							<div class="fh5co-post-text">
                <h3><a href="#">Dinner Setup </a></h3>
							...
							<div class="fh5co-post-meta">
								<a href="#"><i class="icon-chat"></i>Kenmosa</a>
								<a href="#"><i class="icon-clock2"></i> 2 hours ago</a>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="fh5co-features">
						...
						<div class="fh5co-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
							<div class="icon"><i class="icon-cake"></i></div>
							<h3>BirthDays</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
						</div>
			...
			<div class="container">
				<div class="row p-b">
					...
					<div class="col-md-3 col-sm-6 fh5co-footer-widget wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.4s">
						<h3>About</h3>
						<p>Events management system was concieved in the great city of champions and serves beyond its boundaries. </p>
						<p><a href="#" class="btn btn-success btn-sm btn-outline">Gallery</a></p>
					</div>
					<div class="clearfix visible-sm-block"></div>
				</div>
				<div class="row fh5co-made">
					<div class="col-md-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
						<p>Made with <i class="heart icon-heart"></i> in Eldoret</p>
					</div>
				</div>
			</div>
		</div>
